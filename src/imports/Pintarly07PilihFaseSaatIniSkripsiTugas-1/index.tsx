import svgPaths from "./svg-j0ynkrwpho";
...
function CategoryModeSwitcherTabsMargin() {
  return <div className="absolute h-[137px] left-[24px] right-[24px] top-[245.5px]" data-name="Category Mode Switcher Tabs:margin" />;
}
...
function AiGuidanceRoadmapPreviewWidgetMargin() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[24px] pb-[32px] right-[24px] top-[746px]" data-name="AI Guidance Roadmap Preview Widget:margin">
...
function RadiogroupPilihFasePengerjaanSkripsiMargin() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[24px] pb-[32px] right-[24px] top-[245px]" data-name="Radiogroup - Pilih Fase Pengerjaan Skripsi:margin">
...
function ActionButtonsSubtext() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[14px] items-center left-[160px] max-w-[448px] right-[160px] top-[849.5px]" data-name="Action Buttons & Subtext">
